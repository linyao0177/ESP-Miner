...
typedef enum {
    ...
    NVS_CONFIG_HASHANCHOR_URL,
    NVS_CONFIG_HASHANCHOR_API_KEY,
    NVS_CONFIG_HASHANCHOR_ENABLED,
    NVS_CONFIG_HASHANCHOR_INTERVAL,
    NVS_CONFIG_HASHANCHOR_DEVICE_ID,
    NVS_CONFIG_HASHANCHOR_ETH_ADDRESS,

    NVS_CONFIG_CLAW_ENABLED,
    NVS_CONFIG_CLAW_INTERVAL,
    NVS_CONFIG_CLAW_TELEGRAM_TOKEN,
    NVS_CONFIG_CLAW_TELEGRAM_CHAT,
    NVS_CONFIG_CLAW_ENABLE_GREEN,
    NVS_CONFIG_CLAW_ENABLE_CREDIT,
    NVS_CONFIG_CLAW_ENABLE_RENTAL,
